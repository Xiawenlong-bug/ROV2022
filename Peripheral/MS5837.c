...
{
		return MS5837_WriteByte(MS5837_I2C,MS5837_ADDRESS,0x1e, 0x1e);
}
...
void MS5837_Init(void) 
{
	...
	I2C_Simu_Port_Init(&MS5837_I2C);
	MS5837_Reset();
   MS5837_ReadBuffer(MS5837_I2C,MS5837_ADDRESS,buf,0xa0, 2);
  C[0] = buf[0] << 8 |buf[1];
